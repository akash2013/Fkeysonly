...
public interface FkeysonlyConfig extends Config
{
    ...
    default boolean OnlyInCombat() { return false; }
    ...
    default boolean InventoryTab() { return true; }
    ...
    default boolean PrayerTab() { return true; }
    ...
    default boolean MagicTab() { return true; }
    ...
    default boolean CombatTab() { return true; }
    ...
    default boolean EquipmentTab() { return true; }
}
